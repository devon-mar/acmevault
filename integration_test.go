...
var defaultEnv = map[string]string{
	...
	store.EnvVaultCACert:                   path.Join(testCertDir, testServerCert),
	store.EnvVaultCertAuth:                 vaultCertAuthMount,
	store.EnvVaultClientCert:               path.Join(testCertDir, testClientCert),
	store.EnvVaultClientKey:                path.Join(testCertDir, testClientKey),
